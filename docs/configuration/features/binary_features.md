...
You can set either to be the `validation_measure` in the `training` section of the configuration if the `validation_field` is set as the name of a binary feature.
