...
{% set preprocessing = get_feature_preprocessing_schema("sequence") %}
...
{% set seq_encoder = get_encoder_schema("sequence", "embed") %}
...
{% set seq_encoder = get_encoder_schema("sequence", "parallel_cnn") %}
{{ render_yaml(seq_encoder, parent="encoder") }}
...
{% set seq_encoder = get_encoder_schema("sequence", "stacked_cnn") %}
{{ render_yaml(seq_encoder, parent="encoder") }}
...
{% set seq_encoder = get_encoder_schema("sequence", "stacked_parallel_cnn") %}
{{ render_yaml(seq_encoder, parent="encoder") }}
...
{% set seq_encoder = get_encoder_schema("sequence", "rnn") %}
{{ render_yaml(seq_encoder, parent="encoder") }}
...
{% set seq_encoder = get_encoder_schema("sequence", "cnnrnn") %}
{{ render_yaml(seq_encoder, parent="encoder") }}
