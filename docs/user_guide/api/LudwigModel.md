...
# LudwigModel class [[source]](https://github.com/ludwig-ai/ludwig/blob/master/ludwig/api.py#L93)
...
- **gpu_memory_limit** (int: default: `None`): maximum memory in MB to
...
- **gpu_memory_limit** (int, default: `None`): maximum memory in MB to
  allocate per GPU device.
- **allow_parallel_threads** (bool, default: `True`): allow TensorFlow
